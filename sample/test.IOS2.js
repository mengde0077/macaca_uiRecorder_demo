...
module.exports = function(){
    ...
    it('tap: null, 0', function(){
        return driver.sendActions('tap', {x: null, y: 0});
    });

    it('tap: dismissCoupon ( //*[@name="dismissCoupon"] )', function(){
        return driver.wait('//*[@name="dismissCoupon"]', 30000).sendElementActions('tap');
    });

    it('tap: 我的 ( //*[@name="我的"] )', function(){
        return driver.wait('//*[@name="我的"]', 30000).sendElementActions('tap');
    });

    it('tap: 赚钱 ( //*[@name="赚钱"] )', function(){
        return driver.wait('//*[@name="赚钱"]', 30000).sendElementActions('tap');
    });

    it('tap: dismiss newLogIn ( //*[@name="dismiss newLogIn"] )', function(){
        return driver.wait('//*[@name="dismiss newLogIn"]', 30000).sendElementActions('tap');
    });
