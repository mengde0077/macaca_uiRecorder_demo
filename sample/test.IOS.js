...
module.exports = function(){
    ...
    it('tap: arrowBack ( //*[@name="arrowBack"] )', function(){
        return driver.wait('//*[@name="arrowBack"]', 30000).sendElementActions('tap');
    });

    it('tap: //*[@name="8天"]/XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeTabBar/XCUIElementTypeOther/XCUIElementTypeImage', function(){
        return driver.wait('//*[@name="8天"]/XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeTabBar/XCUIElementTypeOther/XCUIElementTypeImage', 30000).sendElementActions('tap');
    });
    ...
    it('tap: 首页 ( //*[@name="首页"] )', function(){
        return driver.wait('//*[@name="首页"]', 30000).sendElementActions('tap');
    });
