...
exports.unloginStatusToLoginTest = function(){
	//适用版本 3.0.0--3.0.4  
    commBrowser.testCaseDoc("验证未登录状态下，我的 各跳转到登录页面入口 ");
...
exports.loginStatusToLoginTest = function(){
    //适用版本 3.0.0--3.0.4  
    commBrowser.testCaseDoc("验证已登录状态下，我的 原需要登录的入口跳转 正常 ");
    // unitPage.clickDismissCoupon();  //关闭新人红包弹窗
    unitPage.clickMine();   //进入我的
    minePage.clickBtnSetting();   //点击 设置
    minePage.clickFunZHAQ();    //点击 账户安全
...
exports.getUserInfo = function(){
    //适用版本  3.0.0--3.0.4 
    commBrowser.testCaseDoc("校验用户账户信息 ");
    minePage.getBalance();
    minePage.testBalance('￥0.00');
    minePage.testSalary('￥0.00');
    minePage.testPoint('0');
    minePage.testLoan('￥0.00');
...
exports.userSettingTest = function(){
    //适用版本  3.0.0--3.0.4 
    commBrowser.testCaseDoc("我的 设置 相关功能验证 ");
    unitPage.clickMine();   //点击 “我的”
    minePage.clickBtnSetting();   //点击 设置
...
exports.loginOffTest = function(){
    //适用版本  3.0.0--3.0.4 
    commBrowser.testCaseDoc("我的  退出登录流程 ");
    unitPage.clickMine();   //点击 “我的”
    minePage.clickBtnSetting();   //点击 设置
